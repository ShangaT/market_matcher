...
ALLOWED_HOSTS = os.environ.get(
    "DJANGO_ALLOWED_HOSTS").split(" ") if DOCKER else []
...
ROOT_URLCONF = 'market_matcher.urls'
...
WSGI_APPLICATION = 'market_matcher.wsgi.application'
...
#         "NAME": os.environ.get("SQL_DATABASE", os.path.join(BASE_DIR, "./parser/db.sqlite3")),
#         "USER": os.environ.get("SQL_USER", "market_matcher"),
#         "PASSWORD": os.environ.get("SQL_PASSWORD", "market_matcher"),
...
STATIC_URL = 'data_analysis/static/'
# STATICFILES_DIRS = [
#     BASE_DIR / "static",
#     '/var/www/static/',
# ]
